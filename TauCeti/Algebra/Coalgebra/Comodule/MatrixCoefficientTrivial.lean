...
the rank-one group-like comodule `R`, this inclusion is an equality. Specializing to `g = 1`,
a trivial comodule's coefficient subalgebra is also contained in the bottom `R`-subalgebra,
and for the rank-one trivial comodule this inclusion is an equality.
